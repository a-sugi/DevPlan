...
namespace DevPlan.UICommon.Utils.Tests
{
    ...
    public class StringUtilTests
    {
        ...
        #region SjisByteLength()のテスト
        [TestMethod()]
        public void SjisByteLengthTest()
        {
            // メソッド実行
            var result = StringUtil.SjisByteLength("");
        ...
        [TestMethod()]
        public void SjisByteLengthTest2()
        {
            // メソッド実行
            var result = StringUtil.SjisByteLength("あいうえお");
        ...
        [TestMethod()]
        public void SjisByteLengthTest3()
        {
            // メソッド実行
            var result = StringUtil.SjisByteLength("abcde");
        ...
        [TestMethod()]
        public void SjisByteLengthTest4()
        {
            // メソッド実行
            var result = StringUtil.SjisByteLength("～");
        ...
        [TestMethod()]
        public void SjisByteLengthTest5()
        {
            // メソッド実行
            var result = StringUtil.SjisByteLength("①");
        ...
        public void SjisByteLengthTest6()
        {
            // メソッド実行
            StringUtil.SjisByteLength(null);
        }
        #endregion

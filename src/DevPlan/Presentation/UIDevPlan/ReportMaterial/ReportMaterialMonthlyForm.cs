...
{
    public partial class ReportMaterialMonthlyForm : BaseForm
    {
        #region プロパティ
        /// <summary>画面名</summary>
        public override string FormTitle { get { return "情報元一覧（月報）"; } }
        ...
        /// コンストラクタ
        /// </summary>
        public ReportMaterialMonthlyForm()
        {
            InitializeComponent();
        }
        #endregion
        ...
        /// <param name="e"></param>
        private void InfoListMonthlyForm_Load(object sender, EventArgs e)
        {
            //画面初期化
            this.Init();
        }
        ...
        private void SerchItems()
        {
            ...
            else
            {
                ...
                foreach (InfoListModel item in this.ItemList)
                {
                    ...
                    InfoListDataGridView.Rows[idx].Cells["SectionCode"].Value = item.SECTION_CODE;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void InfoListMonthlyForm_Shown(object sender, EventArgs e)
        {
            InfoListDataGridView.CurrentCell = null;
        }
        #endregion

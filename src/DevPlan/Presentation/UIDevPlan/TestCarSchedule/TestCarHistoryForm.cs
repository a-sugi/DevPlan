...
namespace DevPlan.Presentation.UIDevPlan.TestCarSchedule
{
    ...
    /// 作業履歴(試験車画面)
    /// </summary>
    public partial class TestCarHistoryForm : BaseSubDialogForm
    {
        #region メンバ変数
        ...
        #region プロパティ
        /// <summary>画面名</summary>
        public override string FormTitle { get { return "作業履歴(試験車)"; } }
        ...
        public TestCarScheduleItemModel ScheduleItem { get; set; }
        ...
        private void InitForm()
        {
            ...
            var isTestCar = base.GetFunction(FunctionID.TestCar).MANAGEMENT_FLG == '1';
            ...
            //試験車の編集ボタン
            this.ScheduleItemEditButton.Visible = isTestCar;
        ...
        private void FavoriteComboBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            //利用許可があるかどうか
            if (!isAllGeneralCode && item.PERMIT_FLG != 1)
            {
        ...
        private void FavoriteEditButton_Click(object sender, EventArgs e)
        {
            ...
            {
                // データ区分
                CLASS_DATA = Const.FavoriteTestCarWorkHistory
        ...
        {
            var item = new ScheduleItemModel<TestCarScheduleItemModel>()
            {
                // ID
                ID = ScheduleItem.ID,
        ...
        {
            //注意ダイヤログ表示
            using (var form = new TestCarHistoryAlertForm())
            {
                //OKかどうか
        ...
        /// <param name="id">ID</param>
        /// <returns></returns>
        private TestCarScheduleItemModel GetScheduleItem(long id)
        {
            //パラメータ設定
            var cond = new TestCarScheduleSearchModel { ID = id };
        ...
        private bool EntryWorkHistory()
        {
            ...
            {
                //作業履歴登録
                var res = HttpUtil.PutResponse(ControllerType.TestCarWorkHistory, list);

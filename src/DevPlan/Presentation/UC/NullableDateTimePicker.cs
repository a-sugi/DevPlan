...
namespace DevPlan.Presentation.UC
{
    ...
    public partial class NullableDateTimePicker : DateTimePicker, ISupportInitialize
    {
        ...
        public NullableDateTimePicker()
        {
            ...
            this.ValueChanged += (o, ev) =>
            {
                if (this.CustomFormat != Const.FormatMonth)
                {
                    return;
                ...
                if (this.Value != null)
                {
                    var day = this.SelectedDate.Value;

                    this.Value = new DateTime(day.Year, day.Month, 1);
            ...
            set
            {
                ...
                else //Value is nto null
                {
                    ...
                    else//change to the new value(changed event fires from base class
                    {
                        ...
                        // OS環境依存により、DateTimePikkerのMinValue(1753/01/01)とMaxValue(9998/12/31)範囲外エラーによる対応
                        // try,catch
                        try
                        {
                            _isNull = false;
        ...
        #region DesignerModifiers
        [Browsable(true)]
        [DefaultValue(DateTimePickerFormat.Long), TypeConverter(typeof(System.Enum))]
        #endregion
        ...
        public DateTime? SelectedDateTime
        {
            get
            {
                ...
                return date == null ? null : (DateTime?)(DateTime)date;
        ...
        public DateTime? SelectedDate
        {
            get
            {
                ...
                return date == null ? null : (DateTime?)date.Value.Date;

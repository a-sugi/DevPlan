...
namespace DevPlan.Presentation.Common
{
    ...
    /// ソート指定
    /// </summary>
    public partial class MultiRowSortForm : BaseSubForm
    {
        #region プロパティ
        /// <summary>画面名</summary>
        ...
        public IEnumerable<MultiRowSortModel> SortTarget { get; set; }

        /// <summary>ソート順</summary>
        public IEnumerable<MultiRowSortModel> Sort { get; set; }
        #endregion
        ...
        {
            //ソート対象
            var list = (new[] { new MultiRowSortModel() }).Concat(this.SortTarget).ToArray();
        ...
        private void SortButton_Click(object sender, EventArgs e)
        {
            ...
            var list = new List<MultiRowSortModel>();

            Action<ComboBox, RadioButton> setSort = (cmb, radio) =>
            {
                if (cmb.SelectedIndex > 0)
                {
                    var item = cmb.SelectedItem as MultiRowSortModel;

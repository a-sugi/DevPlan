...
namespace DevPlanWebAPI.Logic
{
    ...
    /// 業務ロジッククラス
    /// </summary>
    /// <remarks>仕向地検索</remarks>
    public class DestinationLogic : BaseLogic
    {
        /// <summary>
        /// 仕向地データの取得
        /// </summary>
        /// <returns>DataTable</returns>
        public DataTable GetData(DestinationInModel val)
        {
            ...
            sql.AppendLine("AND ( 試験車履歴情報.仕向地 IS NOT NULL )");
            ...
            sql.AppendLine("GROUP BY 試験車履歴情報.仕向地");
            sql.AppendLine("ORDER BY 試験車履歴情報.仕向地");

...
namespace DevPlanWebAPI.Logic
{
    ...
    /// 業務ロジッククラス
    /// </summary>
    /// <remarks>メーカー名検索</remarks>
    public class MakerNameLogic : BaseLogic
    {
        /// <summary>
        /// メーカー名データの取得
        /// </summary>
        /// <returns>DataTable</returns>
        public DataTable GetData(MakerNameSearchInModel val)
        {
            ...
            sql.AppendLine("AND ( 試験車履歴情報.メーカー名 IS NOT NULL )");
            ...
            sql.AppendLine("GROUP BY 試験車履歴情報.メーカー名");
            sql.AppendLine("ORDER BY 試験車履歴情報.メーカー名");

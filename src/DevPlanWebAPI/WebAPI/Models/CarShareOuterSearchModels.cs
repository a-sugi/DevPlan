...
{
    #region カーシェア外製車検索入力モデル
    /// <summary>
    /// カーシェア外製車検索入力モデルクラス
    /// </summary>
    public class CarShareOuterSearchInModel
    {
        /// <summary>
        /// カーシェア利用フラグ
        /// </summary>
        [Display(Name = "カーシェア利用フラグ")]
        public bool CARSHARE_FLG { get; set; } = false;
    }
    #endregion

    #region カーシェア外製車検索出力モデル
    /// <summary>
    /// カーシェア外製車検索出力モデルクラス
    /// </summary>
    public class CarShareOuterSearchOutModel
    {
        /// <summary>
        /// 車系
        /// </summary>
